...
import { GridSwitch, GridDatePickerField, GridTextField, GridSelectField, GridRow, FormContainer } from '../helper'
...
class Task extends Component {
    ...
    render() {
        const { task, platforms, taskTags, taskTypes, taskSubTypes } = this.state;
        return <React.Fragment>
            ...
            {task && < Formik
                ...
                onSubmit={values => {this.props.dispatch(taskActions.addOrUpateTask(values));}}
                render={({ errors, }) => (
                    <FormContainer title={this.needCreate() ? '添加任务' : `修改任务：${task.name}`}>
                        <Grid container spacing={24} direction="column"   >
                            ...
                            <GridRow >
                                ...
                                <GridTextField name="description" value={task.description} label="任务描述" style={{ width: 660 }} errors={errors} onChange={this.onPropertyChange} />
                            </GridRow>
